 ...
 * @author DLB
 * @author https://github.com/Shoarzi/Raf.git, originally done by Mickael Cappelle.
 */
public class BinaryHeap<E extends Comparable<E>> extends PriorityQueue<E> {
    ...
    //complexite O(n)
    //a removed object must be in the heap.
    ...
    //the heap must have an element to find its min.
    public E findMin() {
